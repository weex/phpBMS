...
function cal_popup2 (str_datetime) {
	...
	var obj_calwindow = window.open(
		this.basepath+'calendar.php?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
		'Calendar', 'width=340,height='+(this.time_comp ? 260 : 210)+
		',status=no,resizable=no,dependent=yes,alwaysRaised=yes,modal=yes'
	);
