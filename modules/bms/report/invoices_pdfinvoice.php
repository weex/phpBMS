<?PHP
	...
	while($therecord=mysql_fetch_array($thequery)) {
		...
		$totalwidth=.75;
		$amountduewidth=1;
		$totaltniwidth=$paperwidth-$leftmargin-$rightmargin-$totalwidth-$taxwidth-$shippingwidth-$amountduewidth-.03;	
		...
		$pdf->Cell($amountduewidth,.15,"\$".number_format($therecord["amountdue"],2),$border_debug,0,"R");
