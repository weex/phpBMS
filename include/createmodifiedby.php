...
<input name="creationdate" type="text" value="<?PHP echo formatDateTime($therecord["creationdate"]) ?>" size="20" maxlength="164" readonly="true" class="uneditable" style="width:135px;margin-bottom:2px;" tabindex="-1" />
</td>
...
<input name="modifieddate" type="text" value="<?PHP echo formatTimestamp($therecord["modifieddate"],true) ?>" size="20" maxlength="164" readonly="true" class="uneditable" style="width:135px;margin-bottom:2px;" tabindex="-1" />
</td>
</tr>
