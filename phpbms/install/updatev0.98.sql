...
--menu INSERT--
DELETE FROM `menu`;
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('522', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', 'Tools', '', '', '3', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('523', 'menu:d9e0eaa6-26b3-fcfb-f1b5-ee0eef8a857a', 'Notes', 'search.php?id=tbld%3Aa4cdd991-cf0a-916f-1240-49428ea1bdd1', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '30', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('524', 'menu:03e984b6-d7ac-def2-a4f5-662003e94bfd', 'Tasks', 'search.php?id=tbld%3A2bc3e683-81f9-694a-9550-a0c7263057de', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '40', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('525', 'menu:c4871074-90e9-c9bb-bcf9-b69ca0c30e8b', 'Events', 'search.php?id=tbld%3A0fcca651-6c34-c74d-ac04-2d88f602dd71', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '50', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('526', 'menu:2bcd88e6-703f-128c-7f18-1aad44fb46fb', 'Snapshot', 'modules/base/snapshot.php', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '10', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('527', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', 'System', '', '', '10', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('528', 'menu:e44cf976-658a-50d7-4a8f-b575713e3964', 'Configuration', 'modules/base/adminsettings.php', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '10', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('529', 'menu:cf16add3-b02a-bd9b-b3c7-3fe9d0d2e0ba', 'Users', 'search.php?id=tbld%3Aafe6d297-b484-4f0b-57d4-1c39412e9dfb', 'menu:f07d910f-f56d-3d24-e74f-7a3b36b2d3c8', '40', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('530', 'menu:d727dda4-6ac5-dd23-992b-7cf64cd96620', 'Roles', 'search.php?id=tbld%3A87b9fe06-afe5-d9c6-0fa0-4a0f2ec4ee8a', 'menu:f07d910f-f56d-3d24-e74f-7a3b36b2d3c8', '50', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('531', 'menu:afddfee1-5ab7-2064-204f-816e9df929ac', '----', 'N/A', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '15', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('532', 'menu:9c845b2d-7383-4182-1bf5-fe9b770f1d63', 'Menu', 'search.php?id=tbld%3A83187e3d-101e-a8a5-037f-31e9800fed2d', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '50', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('533', 'menu:ef5853a0-3b57-06e5-a8d4-31bfbdb207b5', 'Files', 'search.php?id=tbld%3A80b4f38d-b957-bced-c0a0-ed08a0db6475', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '910', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('534', 'menu:1f72cd68-1e5a-e718-3b38-8671da9b0a1d', 'Saved Searchs/Sorts', 'search.php?id=tbld%3Ae251524a-2da4-a0c9-8725-d3d0412d8f4a', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '930', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('535', 'menu:00ddbccd-2761-3347-22ee-1adce9696b66', '----', 'N/A', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '45', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('536', 'menu:8825339e-76a8-b51a-fdce-7b409451962c', 'Reports', 'search.php?id=tbld%3Ad595ef42-db9d-2233-1b9b-11dfd0db9cbb', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '70', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('537', 'menu:2dea83ff-2927-0859-ab97-530ee76e7bb8', 'Relationships', 'search.php?id=tbld%3A8d19c73c-42fb-d829-3681-d20b4dbe43b9', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '60', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('538', 'menu:76f8b6cd-f42d-0823-3e12-5cbe39f7fbdb', 'Table Definitions', 'search.php?id=tbld%3A5c9d645f-26ab-5003-b98e-89e9049f8ac3', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '940', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('539', 'menu:f1780935-8018-d240-8e74-f8fde4f8e1bb', 'Modules', 'search.php?id=tbld%3Aea159d67-5e89-5b7f-f5a0-c740e147cd73', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '60', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('540', 'menu:e0a2cc66-9b44-f0cb-84a7-45eb3307298f', 'My Account', 'modules/base/myaccount.php', 'menu:f07d910f-f56d-3d24-e74f-7a3b36b2d3c8', '20', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('541', 'menu:b63e3218-0a12-3e51-88b7-8af400a74a7e', 'Scheduler', 'search.php?id=tbld%3A83de284b-ef79-3567-145c-30ca38b40796', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '32', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('542', 'menu:5f875b57-f499-2307-6d57-61ba49b72e82', 'System Log', 'search.php?id=tbld%3A3f71ab66-1f84-d68b-e2a3-3ee3bb0ec667', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '20', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('543', 'menu:bd2181f5-b938-011b-7e44-81728310bdf5', 'Smart Searches', 'search.php?id=tbld%3A29925e0a-c825-0067-8882-db4b57866a96', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '80', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('544', 'menu:f8392545-41f4-d39a-da7e-9116c9a35502', 'Tabs', 'search.php?id=tbld%3A7e75af48-6f70-d157-f440-69a8e7f59d38', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '100', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('545', 'menu:3620bdc0-edaa-ad59-8ac5-193f855a9584', 'Log Out', 'logout.php', 'menu:f07d910f-f56d-3d24-e74f-7a3b36b2d3c8', '10', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('546', 'menu:2da14499-f301-9b18-e384-e0e73f06509e', 'Help', '', '', '200', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('547', 'menu:113b56da-3722-6518-4c6a-7804d7ed0d19', 'About phpBMS', 'javascript:menu.showHelp()', 'menu:2da14499-f301-9b18-e384-e0e73f06509e', '0', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('548', 'menu:08a6bb60-4557-b7d2-f2ba-09d828a1d9b2', 'Snapshot Widgets', 'search.php?id=tbld%3A2ad5146c-d4c0-db8e-592a-c0cc2f3c2c21', 'menu:bbc91ea7-d7e4-33b7-503e-5eb1b928f28b', '90', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('549', 'menu:30bc9743-3530-7705-283a-d740b19238cf', '----', 'N/A', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '20', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('550', 'menu:13e03413-2f08-9b48-98a2-9bb83e4d15a1', '----', 'N/A', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '900', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('551', 'menu:83d23ec3-ad10-09e1-8c80-72de0c4747f9', '----', 'N/A', 'menu:1e23c59e-c429-fec5-cc94-99b53c4fc6b0', '920', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('552', 'menu:f07d910f-f56d-3d24-e74f-7a3b36b2d3c8', 'Account', '', '', '5', 1, 1, NOW(), NOW(), '');
INSERT INTO `menu` (`id`, `uuid`, `name`, `link`, `parentid`, `displayorder`, `createdby`, `modifiedby`, `creationdate`, `modifieddate`, `roleid`) VALUES ('553', 'menu:e8401ebb-c369-304f-053d-8195988e7faf', '----', 'N/A', 'menu:f07d910f-f56d-3d24-e74f-7a3b36b2d3c8', '30', 1, 1, NOW(), NOW(), '');
--end menu INSERT--
--modules UPDATE--
